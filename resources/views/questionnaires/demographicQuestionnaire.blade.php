                        ...
                        <form class="pb-4" action="{{ route('demographics.create') }}" method="POST">
                            ...
                            <div class="pt-1">
                                ...
                                <div class="my-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="flex items-center mr-4">
                                            ...
                                            <label for="inline-4-gender"
                                                   class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Prefer not to say</label>
                                        </div>
                                    </div>
                                    <div class="my-5">
                                        <p class="font-bold pb-1">Sector:</p>
                                        <input required type="text" name="sector" min="2" max="64" placeholder="Industrial Technology"
                                               class="block text-sm px-4 rounded-lg py-3 border outline-none"/>
                                    </div>
                                    <div class="my-5">
                                        <p class="font-bold pb-1">Role:</p>
                                        <input required type="text" name="role" min="2" max="64" placeholder="Employee"
                                               class="block text-sm px-4 rounded-lg py-3 border outline-none"/>
                                    </div>
                                    <div class="my-5">
                                    ...
                                    <div class="my-5">
                                        <p class="font-bold pb-1">Experience Level:</p>
                                        <select required name="experience_level" id="experience_level" class="block text-sm py-3 pl-4 pr-10 rounded-lg border outline-none appearance-none">
                                ...
                                <!--  <div class="g-recaptcha" data-sitekey="{{ $recaptcha_sitekey ?? env('NOCAPTCHA_SITEKEY') }}"></div> -->
                                ...
                                <div class="my-5">
                                    ...
                                    <input required type="text" name="prolific_id" pattern=".{24}" placeholder="Prolific ID (24 characters)"
                                           class="block text-sm px-4 rounded-lg py-3 border outline-none"/>
                                </div>
                                @endif--}}
                            </div>
