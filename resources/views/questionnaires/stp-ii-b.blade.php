            ...
            <div class="pt-12 px-12 m-10 bg-white rounded-2xl shadow-xl z-20">
                <div class="p-6 text-sky-900">
                    ...
                    <form class="pb-4" action="{{ route('susceptibility-to-persuasion-ii.create') }}" method="POST">
                        ...
                        <p class="text-3xl font-bold text-center mb-4 cursor-pointer">@lang('questionnaire-campaign.stp-ii-b.stpIIBQuestionnaire')</p>
                        @php
                            $questionsPerTab = 9;
                        @endphp
                        ...
                        <div class="flex w-full items-center py-4">
                            ...
                            <div class="flex w-1/3 justify-center">
                                ...
                                <x-primary-button id="submit" class="hidden"
                                    type="submit">@lang('questionnaire-campaign.stp-ii-b.submit')</x-primary-button>
                            </div>
                        </div>
...
<x-modal name="error-modal" id="error-modal" title="Compile all the questions!" :show="false">
    <div class="p-4 rounded-lg relative text-center">
        <p class="text-2xl font-semibold text-red-700 pb-8">@lang('questionnaire-campaign.stp-ii-b.compileError')</p>
