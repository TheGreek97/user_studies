       ...
       <div class="min-h-screen bg-gray-200 flex justify-center items-center">
            <div class="p-12 m-10 bg-white rounded-2xl shadow-xl z-20">
                ...
                <p class="text-xl max-w-4xl text-left pt-4">
                    ...
                    participation. If this last step is skipped, it will be impossible for us or Prolific to acknowledge
                    a user actually completing the study.
                </p>
                ...
                <div class="text-xl max-w-4xl text-left pt-4">
                    ...
                    <ol class="list-disc" style="margin: revert; padding: revert;">
                        <li>
                            I confirm that I have read and understood the information sheet dated 5 February 2024,
                            version number 24/02/24 for the above study. I have had the opportunity to consider the
                            information and asked questions which have been answered to my satisfaction.
                        </li>
                        <li>
                            I consent voluntarily to be a participant in this project and understand that I can refuse
                            to take part and can withdraw from the study at any time, without having to give a reason,
                            up until 31/03/2024.
                        </li>
                        <li>
                        ...
                        <li>
                            I agree that the research team can archive my anonymous data for future research projects.
                        </li>
                        <li>
                        ...
                        <li>
                            I consent to my non-identifiable data being stored at a third party data storage provider,
                            ReCaS data center, University of Bari (Italy), as described in the information sheet above.
                        </li>
                    </ol>
                    <p>
                        Date: {{date("d/m/Y")}}
