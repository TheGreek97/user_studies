            ...
            <div class="p-12 m-10 bg-white rounded-2xl shadow-xl z-20">
                <div>
                    ...
                    <div class="text-xl max-w-2xl text-left pt-3">
                        Unfortunately, due to <a href="https://researcher-help.prolific.com/en/article/fb63bb">Prolific's attention and comprehension check policy</a>, you do not meet the requirements to complete this study.
                        ...
                        <div class="py-4 flex flex-col border-b-2 border-gray-300">
                            <p class="text-left md:text-center text-lg md:text-xl font-semibold text-gray-800 py-3">
                                Please select <em>Fairly agree</em> for this item.
                            </p>
                                ...
                                @for ($i = 1; $i <= 5; $i++)
                                    <div class="flex flex-col items-center w-1/5">
                                        ...
                                        <label
                                            ...
                                            @lang("phishing_assessment.scale.$i")
                                        </label>
                                    </div>
                                @endfor
                            </div>
