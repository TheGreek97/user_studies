...
<div class="interstitial-wrapper">
    <div id="main-content">
        ...
        <div id="main-message">
            ...
            <p>Attackers on <strong>{{ $hostname }}</strong> may trick you into doing something dangerous like installing software or revealing your personal information (for example, passwords, phone numbers, or credit cards). <a href="/nextstep/{{ $_GET['email_id'] }}" id="learn-more-link">Learn more</a></p>
            <div id="debugging">
        ...
        <div id="extended-reporting-opt-in" class="hidden">
            <label>
                ...
                <span id="opt-in-label">Help improve security on the web for everyone by sending <a href="#" id="whitepaper-link">URLs of some pages you visit, limited system information, and some page content</a> to Google. <a id="privacy-link" href="chrome-error://chromewebdata/#">Privacy policy</a></span>
            </label>
        </div>
    ...
    <div class="nav-wrapper">
        <button id="primary-button" onclick="primary_button_click()">Back to safety</button>
        <button id="proceed-button" class="secondary-button small-link hidden"></button>
        <button id="details-button" onclick="details_button_click()" class="secondary-button small-link" aria-expanded="false">Details</button>
    </div>
    <div id="details" class="hidden">
        <p>Google Safe Browsing recently <a href="#" id="diagnostic-link">detected phishing</a> on {{ $hostname }}. Phishing sites pretend to be other websites to trick you.</p>
        <p id="final-paragraph">You can <a href="#" id="report-error-link">report a detection problem</a> or, if you understand the risks to your security, <a href="/nextstep/{{ $_GET['email_id'] }}" id="proceed-link">visit this unsafe site</a>.</p>
    </div>
</div>
