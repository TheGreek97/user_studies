...
class Training extends Model
{
    ...
    /*
    For the non-customized condition, we use a predefined training module generated by o3-mini. If the model changes,
    this should be updated as well to include a training generated by the updated LLM.
    */
