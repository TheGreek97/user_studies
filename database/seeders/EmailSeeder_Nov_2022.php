...
class EmailSeeder_Nov_2022 extends Seeder
{
    /**
            ...
            <tbody>
               <tr>
                  <td>
                    ...
                    '. get_explanation () .
                        '<br>Link goes to: <a href="#" style="text-decoration: underline;/* color: #0001F1; */"><span class="s2">http://92.233.24.33/tiktok/login.php</span></a>
                    </span>
                  </td>
               </tr>
           </tbody>
        ...
        <table class=\"tooltip\" style=\"padding:3px;border: 4px solid  #b80000;\" data=\"pulsante link trenitalia\" data-tool=\"classico\" >
            <tbody>
               <tr>
                  <td>
                    <div style=\"margin-left: auto; margin-right: auto; font-weight: bold; border-radius: 5px; background-color: #c41329; color: #ffffff; font-size: 14px; display: inline-block; text-align: center;\" align=\"center\">
                        <a style=\"color: #ffffff; text-decoration: none; display: block; padding: 14px 30px 15px;pointer-events: none;\" href=\"http://scam-you_.com.br/21322/details.php?id=98324hfduyu23vuyfeoIUhriunN$\"> Activate the discount cupon </a>
                    </div>
                  </td>
               </tr>
            </tbody>
