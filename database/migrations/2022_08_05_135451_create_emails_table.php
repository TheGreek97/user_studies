...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $email->subject = "End stop confirmed";
        $email->preview_text = 'Your stop is over. Dear user,
your stop is over.';
        $email->content = '<div>
<div class="adM"> </div>
...
<div id=":rx" class="T-I J-J5-Ji aQv T-I-ax7 L3 a5q" tabindex="0" role="button" aria-label="Scarica allegato " data-tooltip-class="a1V" data-tooltip="Scarica">
<div class="akn">
...
<td style="max-width: 534px; background: white; border-color: white; width: 94%;" width="94%"><center><span style="font-family: Calibri,sans-serif; color: #a45a95; font-size: 1.7em;"><strong>End stop confirmed</strong></span></center><br /><br /><span style="font-family: Calibri,sans-serif; color: #4f4f4f; font-size: 1.1em;">Dear User, <br />your parking time is <strong>over</strong>. <br /><br />Here are all the details: <br /></span>
...
<div class="adL"> </div>
        ...
        $email->content = "<p class=\"p1\">Congratulations!<br /><br />For you who have already had the opportunity to appreciate our services, here is a discount voucher worth 10 €. To get the discount voucher click on the button and insert your personal data.</p>
...
<table class=\"tooltip\" style=\"padding:3px; border: 4px solid  #b80000;\" data=\"testo trenitalia\" data-tool=\"classico\">
    <tbody>
                                                       <tr>
                                                          <td>
<p class=\"p1\">The discount vaucher chen be activated by 31/09/2023. Activate it and use it immediately on your next purchase.</p>
...
<p class=\"p1\"><br />The discount vaucher code has a value of <strong>€ 10</strong> and can <strong>only be used by you customer, Carta FRECIA ,</strong> to purchase single journey tickets of any type.<br /><br />You can use the discount coupon for purchases at the ticket office, at the self-service, at the travel agency, on the website <a id=\"phishing_link\" href=\"#\"><span class=\"s2\">www.trenitalia.com</span></a> (Postoclick and Postoblu booking services are excluded), on the Trenitalia APP or by calling the Call Center 892021 (paid number).<br /><br /><strong>Book your next trip now!</strong></p>";
        ...
        $email->content = '<p class="p1">Dear customer,</p>
<br/>
...
<p class="p1">Poste italiane</p>';
        ...
        $email->subject = "Notice of expiry of the Auto Policy";
        $email->preview_text = 'Dear customer, we send you an email to remind you of the expiration of your car policy.';
        $email->content = '<p class="p1"><img style="display: block; margin-left: auto; margin-right: auto;" src="/assets/img/email/unipolsai.png" alt="" width="200" height="57" /></p>
...
<p class="p1">Our best regards.</p>';
        ...
        $email->content = "<p class=\"p1\"><strong><img style=\"display: block; margin-left: auto; margin-right: auto;\" src=\"/assets/img/email/tiktok.jpeg\" alt=\"\" width=\"300\" height=\"165\" /></strong><strong>Hey user,</strong></p>
<p> </p>
...
<td class="m_2866944059712879390padfoot" style="padding-bottom: 20px; font-family: Roboto,Helvetica Neue,Helvetica,Arial,sans-serif; font-size: 12px; color: #9a9a9a; line-height: 18px; padding-left: 30px; padding-right: 30px; font-weight: 300;" align="left" valign="top">We sent you this email to notify you of important changes affecting the YouTube Terms of Service.</td>
        ...
        $email->content = '<p><img style="display: block; margin-left: auto; margin-right: auto;" src="/assets/img/email/mps.png" alt="" width="300" height="109" /></p>
<p>Hi {user_name},</p><br>
<p>you have just logged into <a href="' . url('/nextstep') . '" style="text-decoration: underline; color: #0001F1;">www.mps.it</a>.</p>
<br><p>Best regards,<br />the M.P.S. Team.</p>';
        $email->date = Carbon::today()->subDays(mt_rand(0, 365))->toDateTimeString();
        $email->type = 'inbox';
        $email->save();
        ...
        $email->content = '<p class="p1"><img src="/assets/img/email/amazon.jpg" alt="" width="100" /></p>
...
<p class="p1"><table class="tooltip" data="presentazione generica facebook" style="border: 4px solid  #b80000;">
                                                    <tbody>
                                                       <tr>
                                                          <td>Dear Customer,
...
<p class="p1"><br /><table class="tooltip" data="link facebook"  style="border: 4px solid  #b80000;">
                                                    <tbody>
                                                       <tr>
                                                          <td><a href="#" style="text-decoration: underline; color: #0001F1;pointer-events: none;"><span class="s2">Update your password now</span></a>
                                                                <span id="tooltip_link" class="tooltiptext">The link in the email leads to a site created N days ago. These sites are created specifically to pretend to be authorities or banks and steal your data. If you proceed with navigation you expose yourself to multiple risks.
Link goes to: <a href="#" style="text-decoration: underline;/* color: #0001F1; */"><span class="s2">www.facebook-password.com.br</span></a> </span> </td>
        ...
        $email->content = '<p class="p1"><img style="display: block; margin-left: auto; margin-right: auto;" src="/assets/img/email/dazn.png" alt="" width="102" height="102" /></p>
...
<p class="p1">The DAZN Team</p>';
        ...
        $email->from_email = "pharmacy-24@asl.taranto.it";
        $email->preview_text = 'Hi {user_name}, the analysis result is ready.';
        $email->content = '<p>Hi {user_name},</p><br>
...
<p><img src="/assets/img/email/farmacia.jpeg" alt="" width="100" height="75" /></p>';
        $email->date = Carbon::today()->subDays(mt_rand(0, 365))->toDateTimeString();
        $email->type = 'inbox';
        $email->save();

        //Email 16 BROWSER NATIVE
        $email = new Email();
